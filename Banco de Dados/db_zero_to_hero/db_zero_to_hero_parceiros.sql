...
CREATE TABLE `parceiros` (
  ...
  `cnpj_parceiro` varchar(45) NOT NULL,
  `telefone_parceiro` varchar(45) NOT NULL,
  `endereco_parceiro` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`idparceiros`),
  UNIQUE KEY `cnpj_parceiro_UNIQUE` (`cnpj_parceiro`)
...
-- Dump completed on 2022-12-13  9:44:41
